use ooni::{ServerState, UserState};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   User received credential with:");
    println!("   - Anonymous pseudonym (nym_id)");
    println!("   - Age: {} (days since epoch)", server.today());
    println!("   - Measurement count: 0");
    ...
    println!("   User received updated credential");
    println!("   - Measurement count incremented to 1");
    ...
    println!("   User received updated credential");
    println!("   - Measurement count incremented to 2");
    
    println!("\n=== Example Complete ===");
    println!("\nKey features demonstrated:");
    println!("- Anonymous registration with zero-knowledge proofs");
    println!("- Domain-specific pseudonyms (different per probe location)");
    println!("- Credential updates maintaining unlinkability");
    println!("- All operations use byte serialization for network transmission");
